...
import { uploadValidationMiddleware } from '../middleware/uploadValidationMiddleware.js';
...
fileRoutes.use(authenticateJwt);

fileRoutes.post('/upload', upload.single('file'), uploadValidationMiddleware, (req, res) => fileController.uploadFile(req, res));
